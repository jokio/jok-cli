...
export default function getTypescriptField(fieldName: string, type: IntrospectionTypeRef, {
	isNull,
	isList,
}: Props) {
	switch (type.kind) {
		...
		case 'LIST':
			return getTypescriptField(fieldName, type.ofType, { isList: true, isNull })
