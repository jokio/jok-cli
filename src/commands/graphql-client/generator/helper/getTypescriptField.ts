...
export default function getTypescriptField(
	...
	{ isNullable = true, isList = false, isListItemNullable = true }: Props = {
		isNullable: true,
		isList: false,
	...
	switch (type.kind) {
		...
		case "NON_NULL":
			// if NON_NULL appears before list, then the field/arg is non nullable, otherwise the INNER elements are non-nullable
